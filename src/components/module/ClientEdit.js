...
export default function ClientEdit(props) {
  ...
  if(localStorage.getItem('Token') !== 'undefined')
    ...
    useEffect(()=>{
            axios.get(`${Constants.BASE_URL}/Client/`+ params.id, auth)
            .then(res=>{
                    setInput(res.data);
...
const handleUpdateClient=()=>{
  ...
  console.log(`${Constants.BASE_URL}/Client/Client`); 
  axios.put(`${Constants.BASE_URL}/Client/Update`,input,auth).then(res=>{
          ...
          <div className='row gx-5'>
           ...
           {/*  <div className='col-md-2 my-2'>Int A</div>
            ...
            <div className='col-md my-2'>
              <button type="button" className="btn btn-primary " onClick={handleUpdateClient}>Update</button> 
